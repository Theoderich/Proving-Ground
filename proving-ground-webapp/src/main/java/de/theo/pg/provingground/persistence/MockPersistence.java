...
//        TestSuite testSuite1 = new TestSuite(1, START_RUN_1);
...
//        TestSuite testSuite = project.getTestRun(testSuiteId);
//        return new TestSuiteView(
//                1, 1, "myLittleTestRun",
//                testSuite.getStart(), testSuite.getStatus(), testSuite.getTotalNumberOfTests(),
//                testSuite.getNumberOfSuccessfulTests(), testSuite.getNumberOfFailedTests(), testSuite.getNumberOfSkippedTests());
//    }
//
//    @Override
//    public List<TestRunView> findTestRunsForSuite(long testSuiteId) throws ElementNotFoundException {
//        TestSuite testSuite = project.getTestRun(testSuiteId);
//        List<TestExecution> testExecutions = testSuite.getSortedTestExecutions(false);
//        int idCounter = 0;
...
//        TestSuite testSuite = project.getTestRun(1);
//        TestExecution source = testSuite.getSortedTestExecutions(false).get((int) testRunId);
