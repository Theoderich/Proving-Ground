...
CREATE TABLE BRANCH (
  ...
  CONSTRAINT fk_branch__project__id FOREIGN KEY (fk_project_id) REFERENCES PROJECT (id) ON DELETE CASCADE,
...
CREATE TABLE BUILD (
  ...
  CONSTRAINT fk_build__branch__id FOREIGN KEY (fk_branch_id) REFERENCES BRANCH (id) ON DELETE CASCADE,
...
CREATE TABLE TEST (
  ...
  CONSTRAINT fk_test__branch__id FOREIGN KEY (fk_branch_id) REFERENCES BRANCH (id) ON DELETE CASCADE,
...
CREATE TABLE TEST_RUN (
  ...
  CONSTRAINT fk_test_run__build__id FOREIGN KEY (fk_build_id) REFERENCES BUILD (id) ON DELETE CASCADE,
...
CREATE TABLE ERROR_INFO (
  ...
  CONSTRAINT fk_error_info__test_run__id FOREIGN KEY (fk_test_run_id) REFERENCES TEST_RUN (id) ON DELETE CASCADE
);
